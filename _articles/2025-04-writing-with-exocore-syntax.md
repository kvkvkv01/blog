...
The Exocore utilizes standardized Markdown syntax, along with some additional extensions. Much of the content of this article covers existing markdown syntax used universally in plain text formatting. However, some syntax, such as Wikilinks, images and collapsible sections are particular to this iteration of the Exocore.
...
Here is a basic wikilink, pointing to other posts on this Exocore: `[[what-is-obamacore]]` It renders like this: [[what-is-obamacore]].
...
Hyperlinks to external sites are not the same as wikilinks. A wikilink is a simple way to hyperlink to other posts on your Exocore without using the full processed URL as it is rendered online. To create a hyperlink, use single normal parentheses around the URL you want to point to, and square brackets around the text you want displayed:
...
As you have likely noticed by hovering those links, this version of exocore contains popups.
...
[what-is-obamacore]: ../_wiki/what-is-obamacore "What is Obamacore"
[2025-04-writing-with-exocore-syntax#Wikilink Embeds|This wikilink]: 2025-04-writing-with-exocore-syntax "Writing with Exocore Syntax"
